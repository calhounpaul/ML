...
#docker build -t transformers-quantization-latest-gpu .

#docker run -it --gpus all --rm --name transformers-quantization-latest-gpu -v ../../../ephemera/shared_caches/transformers-quantization-latest-gpu:/root/.cache -v ./workspace:/workspace transformers-quantization-latest-gpu