                ...
                "section_divisions": {
                    ...
                    "items": {
                        ...
                        "properties": {
                            "division_type": {
                                "type": "string",
                                "description": "The type of section division",
                                "enum": ["chapter", "subsection", "abrupt", "other"]
                            },
                            "section_ending_quote": {
                                "type": "string",
                                "description": "The quote that ends the section"
                            },
                            "section_title": {
                                "type": "string",
                                "description": "A succinct, informative title for the section",
                                "minLength": 6
                            },
                            "section_summary": {
                                "type": "string",
                        ...
                        "description": "A dividing point in the text",
                        "required": ["section_ending_quote", "section_title", "section_summary"]
                    }
                }
            },
            "required": ["section_divisions"]
        }
    }
}'''

instruction = """Split the following text into sections (by quoting the final text from each section) and provide a title and summary for each section:
...
split_line_ends = ["..."+line.strip()[-12:] for line in instruction.strip().split("\n")[1:] if len(line.strip())]
function_json["function"]["parameters"]["properties"]["section_divisions"]["items"]["properties"]["section_ending_quote"]["enum"] = split_line_ends
